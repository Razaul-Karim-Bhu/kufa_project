        ...
        <div class="row">
            <div class="col-lg-10 offset-1">
                <div class="card-box">
                    ...
                    <form role="form" action="about-image-post.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <img id="blah" style="height: 80px; width:80px" src="../../uploads1/images1/<?php echo $assoc['thumbnail']; ?>">
                        </div>
