        ...
        <div class="row">
            <div class="col-lg-10 offset-1">
                <div class="card-box">
                    ...
                    <form role="form" action="about-image-update.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <img id="blah" style="height: 80px; width:80px" src="../../uploads/images/<?php echo $assoc['image_name']; ?>">
                        </div>
